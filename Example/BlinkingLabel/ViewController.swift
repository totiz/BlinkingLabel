...
//  BlinkingLabel
//
//  Created by Nattapon Nimakul on 06/06/2016.
//  Copyright (c) 2016 Nattapon Nimakul. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        toggleButton.addTarget(self, action: #selector(toggleBlinking), forControlEvents: .TouchUpInside)
